...
*Line of best fit formula: ŷ = -2.76 + 0.69x. The emailhr estimate is -2.76, this means that when educ is 0, the time spent on emails is estimated to be -2.76*
...
*The model is not suitable, as the data is not continuous, but discrete. There is also no clear trend within the plot, as the data is very far spread from the line of best fit. Furthermore the r squared value is 0.029 which shows that the model is not a good fit.*
...
*Sensitivity is 1 - (118/(118+147)) = 0.556 and Specificity is 1 - (10/10+18) = 0.643*
...
```{r}
gss16_rec_2 <- recipe(advfront ~ polviews + wrkstat + emailhr + educ, 
                      data = gss16_train) %>%
...
*The first model performs better, as the area under the ROC curve is larger than that under the second curve.*
